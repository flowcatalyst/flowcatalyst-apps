...
async function loadConfig() {
	...
	loading.value = true;
	try {
		config.value = await apiFetch<MatchingConfig>(
...
<template>
  <div class="page-container" style="max-width: 700px;">
    ...
    <ProgressSpinner v-else-if="loading" style="display: flex; justify-content: center; padding: 48px;" />
    ...
    <template v-else-if="config">
      <div class="fc-card" style="margin-bottom: 16px;">
        <div class="scope-badge">
          ...
          <span class="scope-hint">
            Config cascade: partition &rarr; client &rarr; global
          </span>
        </div>
      </div>
        ...
        <div class="threshold-list">
          <div class="threshold-row">
            ...
            <div class="threshold-control">
              <Slider v-model="editForm.streetThreshold" :min="0" :max="100" :step="1" style="width: 200px;" />
          ...
          <div class="threshold-row">
            ...
            <div class="threshold-control">
              <Slider v-model="editForm.houseNumberThreshold" :min="0" :max="100" :step="1" style="width: 200px;" />
          ...
          <div class="threshold-row">
            ...
            <div class="threshold-control">
              <Slider v-model="editForm.postalCodeThreshold" :min="0" :max="100" :step="1" style="width: 200px;" />
          ...
          <div class="threshold-row">
            ...
            <div class="threshold-control">
              <Slider v-model="editForm.stateThreshold" :min="0" :max="100" :step="1" style="width: 200px;" />
          ...
          <div class="threshold-row">
            ...
            <div class="threshold-control">
              <Slider v-model="editForm.addressNameThreshold" :min="0" :max="100" :step="1" style="width: 200px;" />
          ...
          <div class="threshold-row overall">
            ...
            <div class="threshold-control">
              <Slider v-model="editForm.overallThreshold" :min="0" :max="100" :step="1" style="width: 200px;" />
      ...
      <div v-else class="fc-card">
        ...
        <div class="threshold-list">
          ...
          <div class="threshold-row">
            <span class="threshold-label">House Number</span>
            <span class="threshold-display">{{ (config.houseNumberThreshold * 100).toFixed(0) }}%</span>
          </div>
          <div class="threshold-row">
            <span class="threshold-label">Postal Code</span>
            <span class="threshold-display">{{ (config.postalCodeThreshold * 100).toFixed(0) }}%</span>
          </div>
          <div class="threshold-row">
            <span class="threshold-label">State / Province</span>
          ...
          <div class="threshold-row">
            <span class="threshold-label">Address Name</span>
            <span class="threshold-display">{{ (config.addressNameThreshold * 100).toFixed(0) }}%</span>
          </div>
          <div class="threshold-row overall">
            <span class="threshold-label">Overall</span>
            <span class="threshold-display overall-value">{{ (config.overallThreshold * 100).toFixed(0) }}%</span>
          </div>
        </div>
      </div>
    </template>
    ...
    <div v-else class="fc-card" style="text-align: center; padding: 48px;">
      ...
      <p style="font-size: 13px; color: #94a3b8;">A global default config is needed. Run sync or create one.</p>
    </div>
  </div>
</template>
