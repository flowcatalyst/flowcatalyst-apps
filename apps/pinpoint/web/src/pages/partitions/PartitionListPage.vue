...
<template>
  <div class="page-container">
      ...
      >
        ...
        <template #empty>
          <div style="text-align: center; padding: 48px;">
            ...
            <Button label="Create First Partition" icon="pi pi-plus" severity="secondary" @click="openCreateDialog" />
          </div>
        </template>
      </DataTable>
    </div>
    ...
    <!-- Create Dialog -->
    <Dialog v-model:visible="showCreateDialog" header="New Partition" :modal="true" style="width: 480px;">
      <form @submit.prevent="handleCreate">
        <div style="display: flex; flex-direction: column; gap: 16px;">
          ...
          <div>
            <label for="description" style="display: block; margin-bottom: 6px; font-weight: 500;">Description</label>
            <InputText
              id="description"
