      ...
      <div v-if="editing" class="fc-card">
        <form @submit.prevent="handleSave">
          <div style="display: flex; flex-direction: column; gap: 16px;">
            ...
            <div>
              <label for="edit-name" style="display: block; margin-bottom: 6px; font-weight: 500;">Name</label>
              <InputText
                id="edit-name"
            ...
            <div>
              <label for="edit-desc" style="display: block; margin-bottom: 6px; font-weight: 500;">Description</label>
              <InputText
                id="edit-desc"
