    ...
    <template v-else-if="location">
      ...
      <div class="page-header">
        ...
        <Tag
          ...
          :severity="statusSeverity(location.status)"
        />
      </div>
        ...
        <div class="detail-grid">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value">
              {{ location.matchConfidence != null ? `${(location.matchConfidence * 100).toFixed(0)}%` : '—' }}
            </span>
          </div>
          <div class="detail-item">
            <span class="detail-label">Master Location</span>
            <span class="detail-value">
              <RouterLink v-if="location.masterLocationId" :to="`/master-locations/${location.masterLocationId}`" class="detail-link">
      ...
      <!-- Matched features -->
      <div v-if="location.features && location.features.length > 0" class="fc-card" style="margin-bottom: 16px;">
