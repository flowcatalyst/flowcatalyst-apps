...
onMounted(async () => {
	...
	try {
		const response = await apiFetch<PartitionListResponse>(
    ...
    <div v-else class="fc-card">
      <form @submit.prevent="handleSubmit">
        <div style="display: flex; flex-direction: column; gap: 16px;">
          <div>
            <label for="address" style="display: block; margin-bottom: 6px; font-weight: 500;">Address</label>
            <InputText
              id="address"
            ...
            <small style="color: #64748b;">
              Enter the full address as a single line. It will be automatically parsed and normalized.
            </small>
          </div>
          ...
          <div>
            <label for="externalId" style="display: block; margin-bottom: 6px; font-weight: 500;">External ID</label>
            <InputText
              id="externalId"
              ...
              class="w-full"
            />
            <small style="color: #64748b;">Used for deduplication when importing from external systems.</small>
          </div>

          <div>
            <label for="partition" style="display: block; margin-bottom: 6px; font-weight: 500;">Partition</label>
            <Select
              id="partition"
