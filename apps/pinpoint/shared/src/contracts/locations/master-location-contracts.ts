...
export type UpdateMasterLocationCommand = z.infer<
  typeof UpdateMasterLocationCommandSchema
>;
...
export type RejectMasterLocationCommand = z.infer<
  typeof RejectMasterLocationCommandSchema
>;
