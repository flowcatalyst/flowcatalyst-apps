...
export async function createAppContext(config: AppContextConfig): Promise<AppContext> {
  ...
  return {
    ...
    useCases: {
      ...
      updateLayerFeature: new UpdateLayerFeatureUseCase(uow, aggregateRegistry, layerFeatureRepo),
      deleteLayerFeature: new DeleteLayerFeatureUseCase(uow, aggregateRegistry, layerFeatureRepo),
...
function logAddressVerifierError(err: unknown): void {
