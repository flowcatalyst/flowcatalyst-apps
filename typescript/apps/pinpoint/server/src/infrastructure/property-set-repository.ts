...
import type { Property, PropertySet } from '../domain/layers/property-set.js';
...
export function createDrizzlePropertySetRepository(db: PostgresJsDatabase): PropertySetRepository {
  ...
  return {
    ...
    async countByLayerIds(layerIds: readonly LayerId[]): Promise<ReadonlyMap<string, number>> {
