...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "TransistorsoftCapacitorBackgroundGeolocation", path: "../../../../../../node_modules/.pnpm/@transistorsoft+capacitor-background-geolocation@9.2.0_@capacitor+core@8.4.1/node_modules/@transistorsoft/capacitor-background-geolocation")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
